...
sources := \
  ...
  amr_restrict_ec_genorder.F \
  amr_restrict_ec_user.F \
  amr_restrict_edge.F \
  amr_restrict_fc_fun.F \
  amr_restrict_fc_genorder.F \
  amr_restrict_fc_user.F \
  amr_restrict_fulltree.F \
  amr_restrict_red.F \
  amr_restrict_unk_fun.F \
  amr_restrict_unk_genorder.F \
  amr_restrict_unk_user.F \
  amr_restrict_nc_fun.F \
  amr_restrict_nc_user.F \
  amr_restrict_nc_genorder.F \
  amr_restrict_work_fun.F \
  amr_restrict_work_genorder.F \
  amr_restrict_work_user.F \
...
.PHONY: clean
clean:
	$(RM) libparamesh.a *.o *~ *.mod GNUmakefile.include
